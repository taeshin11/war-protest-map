...
export const metadata: Metadata = {
  ...
  description: 'War Protest Map Terms of Service — rules and conditions for use.',
  keywords: 'terms of service, user agreement',
}

export default function TermsPage() {
  const sections = [
    { title: '1. Acceptance of Terms', content: 'By accessing War Protest Map at war-protest-map.vercel.app, you agree to these Terms. Continued use after modifications constitutes acceptance.' },
    { title: '2. Description of Service', content: 'War Protest Map is a free, publicly accessible platform that maps anti-war protests, peace demonstrations, and civilian opposition movements to armed conflicts worldwide. For informational and educational purposes only.' },
    ...
    { title: '4. Limitation of Liability', content: 'War Protest Map SHALL NOT BE LIABLE FOR ANY INDIRECT OR CONSEQUENTIAL DAMAGES. Total liability shall not exceed $0, as the Service is entirely free.' },
    ...
    { title: '10. Contact', content: 'Questions? Contact us at contact@war-protest-map.vercel.app.' },
  ]
  return (
